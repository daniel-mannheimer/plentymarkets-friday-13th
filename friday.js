...
*/
var KICKASSVERSION='2.0';window.IS_CLOUDFLARE_GAME = true;
...
(function (window) {
    ...
    var MenuManager = new Class({
        initialize: function (game) {
            ...
            this.container.innerHTML = '<div id="kickass-howto-image" class="KICKASSELEMENT kickass-howto-invisible"></div>' + '<div id="kickass-pointstab" class="KICKASSELEMENT">' +
                adHTML + '<div id="kickass-bomb-menu" class="KICKASSELEMENT KICKASShidden">' + '<ul id="kickass-bomb-list" class="KICKASSELEMENT">' + '</ul>' + '</div>' + '<div id="kickass-weapons-menu" class="KICKASSELEMENT">' + '<ul id="kickass-weapons-list" class="KICKASSELEMENT">' + '</ul>' + '</div>' + '<div id="kickass-pointstab-wrapper" class="KICKASSELEMENT">' + '<div id="kickass-points" class="KICKASSELEMENT">' +
            ...
            this.weaponsMenu.style.width = '120px';
    ...
    var Ships = {
        Standard: {
            ...
            /*{
                ...
                "thrusters": [
                    {
                        "s": {
                            "w": 73.74747474747474,
                            "h": 25.787439613526566
                        },
                        "p": {
                            "x": 1.1287878787878753,
                            "y": 65.60628019323671
                        },
                        "a": 0,
                        "m": ""
                ...
                "name": "CWS SR-71 Website Destroyer"
            }*/
    };
    var PLAYERIDS = 0;
        ...
        Extends: Explosion, initialize: function (pos, element) {
            ...
            for (var i = 0, j = !GameGlobals.hasCanvas ? 10 : 40; i < j; i++) {
                this.particles.push({
                    ...
                    pos: new Vector(0, 0),
                    color: ['#d4021d', '#008ebd'][random(0, 1)]
                });
            }
        }, checkBounds: function () {
    ...
    var Sheet = new Class({
        initialize: function (rect) {
            ...
            this.drawer.setStrokeColor('#d4021d');
            this.drawer.setLineWidth(4);
            ...
            this.drawer.setLineWidth(1.5);
            this.drawer.setFillColor('#d4021d');
